...
<head>
    ...
    <title>Gestión de Productos - Valeria Vega Studio Admin</title>
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="name" required placeholder="Ej: Camiseta Valeria Vega Studio">
                                </div>
